...
import ListPaysSansRedirection from "./components/VersionSansRedirection/ListPays.component"
    ...
    <div className="App">
        <Router>
          ...
          <Switch>
            ...
            <Route path="/VersionSansRedirection" exact component={ListPaysSansRedirection}
